...
export async function generateMetadata(parent) {
  ...
  return {
    ...
    description: "I’m Parthiban Ramachandran, an experienced Web Developer with 3 years of hands-on experience building responsive and dynamic web applications using HTML, CSS, Bootstrap, JavaScript, React.js, and Next.js.",
    openGraph: {
              ...
              <div className="col-lg-9 col-12 mx-auto">
                <div className="about-me mb-4">
                  ...
                  <p className='description'>
                    I’m Parthiban Ramachandran, an experienced Web Developer with 3 years of hands-on experience building
                ...
                <div className='row'>
                  <div className='col-md-6 col-12 about-me'>
                    ...
                    <p className='description mb-2'>
                      Birthday:<span className='text-dark'> January 16, 1998</span>
                    </p>
                  </div>
                  <div className='col-md-6 col-12 about-me'>
                    <p className='description mb-2'>
                    ...
                    <p className='description mb-2'>
                      Email: <span className='text-dark'>rparthiban1612@gmail.com</span>
                    </p>
                  </div>
                </div>
                <div className='mt-4 row'>
                  ...
                  <div className="col-lg-5 col-md-6 col-12">
                    <Link href={"mailto:rparthiban1612@gmail.com"} className="btn-blue shadow w-100 text-decoration-none rounded-5 border-0 px-4 py-2">
                      <GoMail size={15} />
                      Hire me
                    </Link>
                  </div>
